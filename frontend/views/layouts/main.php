    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('<?=$baseUrl?>/img/banner-slide-1.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('<?=$baseUrl?>/img/banner-slide-2.jpg');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>Highest </span>Lorem</h1>
                    <p class="banner_txt">Lorem ipsum dolor sit amet sit legimus copiosae instructior eiut vix denique fierentis ea saperet inimicu utqui dolor oratio mnesarchum.</p>
                    <div class="slider_btn">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('<?=$baseUrl?>/img/banner-slide-3.jpg');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>Highest </span>Lorem</h1>
                    <p class="banner_txt">Lorem ipsum dolor sit amet sit legimus copiosae instructior eiut vix denique fierentis ea saperet inimicu utqui dolor oratio mnesarchum.</p>
                    <div class="slider_btn">
    ...
    <section id="about">
        <div class="image-holder col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-left">
            <div class="background-imgholder">
                <img src="<?=$baseUrl?>/img/1.jpg" alt="about" class="img-responsive" style="display:none;" />
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 block ">
                    ...
                    <div class="testimonial_user">
                        <div class="user-image"><img src="<?=$baseUrl?>/img/user1.png" alt="user" class="img-responsive" /></div>
                        <div class="user-info">
                            <h5>Lorem Ipsum</h5>
                            <p>Manager</p>
                        </div>
